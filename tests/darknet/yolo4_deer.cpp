...
int main() {
    std::string bin_path  = "yolo4_deer";
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/tests/darknet/cfg/yolo4_deer.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/tests/darknet/names/yolo4_deer.names";
